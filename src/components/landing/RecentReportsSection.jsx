...
export default function RecentReportsSection() {
  ...
  if (initialLoad) {
    return (
      <div className="py-16 bg-[#FAFAFA] border-t border-gray-100 flex justify-center">
        <div className="animate-spin w-8 h-8 border-4 border-[#33D6A6] border-t-transparent rounded-full"></div>
      </div>
    );
  }
  ...
  return (
    <div className="py-16 bg-[#FAFAFA] border-t border-gray-100 relative">
        ...
        <div className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h2 className="text-2xl font-extrabold text-[#111827] flex items-center gap-2">
              Update <span className="text-[#33D6A6]">Terbaru</span> ⚡
            </h2>
          ...
          <div className="w-full md:w-auto shrink-0 relative">
            ...
            <select
              ...
              className="w-full md:w-56 pl-9 pr-8 py-2.5 bg-white border border-gray-200 rounded-xl text-sm font-semibold text-gray-600 appearance-none focus:outline-none focus:ring-2 focus:ring-[#33D6A6]/20 cursor-pointer shadow-sm"
            >
            ...
            reports.map((report, index) => (
              <Link href={`/laporan/${report.id}`} key={report.id}>
                <motion.div 
                  ...
                  className="group cursor-pointer bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 hover:border-[#33D6A6] hover:shadow-md transition-all flex w-full h-24 sm:h-28"
                >
                  ...
                  <div className="p-3 sm:p-4 flex flex-col justify-between flex-1 min-w-0">
                    ...
                    <div>
                      <h3 className="text-[#111827] font-bold text-sm sm:text-base line-clamp-1 mb-0.5 group-hover:text-[#33D6A6] transition-colors">
                        {report.judul}
                      </h3>
        ...
        {meta && meta.totalPages > 1 && (
          <div className="flex items-center justify-center gap-6 mt-8">
            <button 
              ...
              className="p-2.5 rounded-full bg-white shadow-sm border border-gray-200 text-gray-600 hover:text-white hover:bg-[#33D6A6] hover:border-[#33D6A6] disabled:opacity-40 disabled:hover:bg-white disabled:hover:text-gray-600 disabled:hover:border-gray-200 transition-all"
            >
              <ChevronLeft size={20} />
            </button>
