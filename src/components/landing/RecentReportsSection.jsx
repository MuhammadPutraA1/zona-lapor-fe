...
import { Calendar, Tag, MessageCircle, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function RecentReportsSection() {
  ...
  const [statusFilter, setStatusFilter] = useState("semua"); // State filter
  ...
  return (
    <div className="py-16 bg-[#FAFAFA] border-t border-gray-100 relative">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        {/* List View (1 Kolom Full Width bergaya Manga/Wattpad) */}
