...
export default function ProfilPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F8FA] flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-4 py-8 sm:py-12 flex flex-col lg:flex-row gap-4 sm:gap-6 items-start">
        
        {/* Tombol Back Bulat di Samping */}
        <button
          onClick={() => router.back()}
          className="shrink-0 w-10 h-10 flex items-center justify-center bg-white border border-gray-200 shadow-sm rounded-full text-gray-500 hover:text-white hover:bg-[#33D6A6] hover:border-[#33D6A6] transition-all hidden sm:flex mt-1"
          title="Kembali"
        >
          <ArrowLeft size={18} />
        </button>
        ...
        <div className="flex-1 w-full">
          ...
          <button
            onClick={() => router.back()}
            className="flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-[#33D6A6] transition-colors mb-4 sm:hidden"
          >
          ...
          <div className="w-full lg:w-1/3 shrink-0">
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden relative">
              {/* Banner Background */}
              <div className="h-32 bg-gradient-to-r from-[#33D6A6] to-emerald-400 relative overflow-hidden">
                {/* Decorative Elements */}
              ...
              <div className="px-6 pb-8 relative flex flex-col items-center text-center">
                ...
                <div className="w-28 h-28 rounded-full border-4 border-white bg-slate-100 shadow-md overflow-hidden relative z-10 -mt-14 mb-4">
                  <img 
                    src={`https://ui-avatars.com/api/?name=${encodeURIComponent(user?.username || 'User')}&background=33D6A6&color=fff&size=256&font-size=0.4`} 
                    alt="Profile Avatar" 
                ...
                {isEditing && (
                  <div className="flex gap-3 pt-4 border-t border-gray-50">
                    ...
                    <button
                      type="submit"
                      disabled={saving}
                      className="flex-1 flex items-center justify-center gap-2 bg-[#33D6A6] hover:bg-emerald-500 text-white font-bold py-3 rounded-xl transition shadow-sm"
                    >
                      <Save size={16} />
