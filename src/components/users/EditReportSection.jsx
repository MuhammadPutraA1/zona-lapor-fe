  ...
  if (isLoading) {
    return (
      <div className="py-32 flex justify-center items-center">
        <Loader2 className="w-10 h-10 text-[#33D6A6] animate-spin" />
      </div>
    );
  }

  return (
    <section className="py-12 relative px-4 bg-[#FAFAFA] min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-end">
                  ...
                  <button type="button" onClick={updateLocation} className="text-xs text-[#33D6A6] font-bold hover:underline">
