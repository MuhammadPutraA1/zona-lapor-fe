                ...
                <div key={tgp.id} className="flex items-start gap-3 sm:gap-4 px-1 sm:px-2 group">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-baseline gap-x-1.5 gap-y-1 mb-1 relative">
                      ...
                      <ShieldCheck size={15} className="text-[#33D6A6]" />
                    ...
                    {editingTanggapanId === tgp.id ? (
                      <div className="mb-3">
                        <textarea
                          ...
                          className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-[15px] focus:outline-none focus:ring-2 focus:ring-[#33D6A6] min-h-[80px]"
                        />
                        <div className="flex justify-end gap-2 mt-2">
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 text-xs font-bold bg-[#33D6A6] text-white rounded-lg hover:bg-emerald-500 transition disabled:opacity-50"
                          >
            ...
            report.status === "pending" ? (
              ...
              <div className="bg-white border border-gray-200 shadow-sm sm:rounded-xl p-4 sm:p-5 mb-6">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <ShieldCheck size={18} className="text-[#33D6A6]" />
                ...
                <form onSubmit={handlePostTanggapan} className="space-y-3">
                  <textarea
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#33D6A6] focus:border-transparent min-h-[100px] transition-all resize-y"
                  />
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto px-6 py-2 bg-[#33D6A6] text-white font-bold text-sm rounded-full hover:bg-[#2bc295] transition-colors disabled:opacity-50 shadow-sm"
                    >
