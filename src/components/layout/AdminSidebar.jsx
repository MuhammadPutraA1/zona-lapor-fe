                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3.5">
                        <Icon className={`w-5 h-5 transition-transform group-hover/item:scale-110 duration-200 ${active ? 'text-[#33D6A6]' : 'text-gray-400 group-hover/item:text-gray-600'}`} />
                        {item.name}
                      </div>
                      {active && <ChevronRight size={14} className="text-[#33D6A6]/60" />}
                    </Link>
                  );
                })}
              </div>
